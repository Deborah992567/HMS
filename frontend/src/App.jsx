...
export default function App() {
  ...
  return <div className="app-shell">
    ...
    <main className="main-content">
      ...
      {page === 'assistant' && <section className="page-section"><div className="section-heading"><p className="eyebrow">Assistant</p><h1>Local AI assistant (Ollama)</h1><p>Uses a locally running Ollama instance (http://localhost:11434) — ensure Ollama is running.</p></div><Chat /></section>}
